...
class TutorialTargets {
  ...
  static final GlobalKey logSymptomQuickActionKey = GlobalKey();
  static final GlobalKey addMedicationQuickActionKey = GlobalKey();
  static final GlobalKey symptomInputKey = GlobalKey();
